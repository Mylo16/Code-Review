...
**[Code-Review]** is a project with basic html and css files. The main motive is to review these files before merging into the main branch
...
-git@github.com:Mylo16/Code-Review.git
